/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 58209d2315cb021b87267c9484528776)
...
interface __BaseEnv_CloudflareBindings {
	...
	ORDER_WORKFLOW: Workflow<Parameters<import("./src/index").OrderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OrderWorkflow";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENCODE_API_KEY" | "OPENCODE_MODEL" | "OPENCODE_VISION_MODEL">> {}
}

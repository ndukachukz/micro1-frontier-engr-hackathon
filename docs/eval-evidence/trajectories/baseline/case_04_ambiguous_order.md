# case_04_ambiguous_order — baseline trajectory
...
- Started: 2026-08-29T13:56:07.552Z · Duration: 2042 ms
...
**Fields that differed from expected**: flags.

- Expected: `needs_clarification` / payment `n/a`
